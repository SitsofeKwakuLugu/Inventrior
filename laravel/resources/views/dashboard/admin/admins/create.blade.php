        ...
        <div class="col-md-6">
            <div class="card shadow-sm">
                <div class="card-body p-5">
                    <h3 class="mb-4" style="color: var(--primary-navy);">Add New Administrator</h3>

                    <form method="POST" action="{{ route('admin.store') }}" id="adminForm">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-silver w-100 mt-4">Create Admin Account</button>
